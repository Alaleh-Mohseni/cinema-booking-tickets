...
function Header() {
    const { logged, setLogged, phoneNumber } = useContext(AuthContext)
                ...
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center lg:order-2">
                        ...
                        {!logged ?
                            ...
                            :
                            <>
                                <button className="text-white bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2">پروفایل</button>
                            </>
                        }
                    </div>
